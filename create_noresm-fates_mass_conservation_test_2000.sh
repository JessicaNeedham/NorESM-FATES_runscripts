...
export COMPSET='2000_DATM%CRUJRA2024_CLM60%FATES_SICE_SOCN_SROF_SGLC_SWAV_SESP'
...
export TAG='noresm-fates-mass_conservation_2000_devel'
...
./xmlchange EXEROOT=/cluster/work/users/jessica/fates-cal-runs/noresm-fates_nocomp_default_case.N77e76a761-F3012a954e.2025-10-29/bld
...
flandusepftdat='/cluster/shared/noresm/inputdata/LU_data_CMIP7/fates_landuse_pft_map_to_surfdata_4x5_hist_1850_16pfts_c241007_251009.nc'
...
'TOTCOLC', 'FATES_VEGC', 'TOTLITC', 'TOTSOMC', 'TOT_WOODPRODC', 'FATES_FRACTION', 'HR', 'FATES_SEED_BANK',
